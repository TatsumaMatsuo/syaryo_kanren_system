...
const REQUIRED_FIELDS = [
  ...
  { name: "name", type: 1 },
  { name: "email", type: 1004 },
  { name: "department", type: 1 },
  { name: "hire_date", type: 5 },
  { name: "resignation_date", type: 5 },
  { name: "created_at", type: 1001 },
];

async function verifyFields() {
  try {
    console.log("=== 社員マスタテーブル フィールド設定検証 ===\n");
    ...
    if (allOk) {
      ...
      console.log("\n次のステップ:");
      console.log("1. ブラウザでテスト: http://localhost:3003/dashboard/employees/new");
    } else {
